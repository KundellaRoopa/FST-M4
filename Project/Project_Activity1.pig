...
inputFile=LOAD 'hdfs:///user/Roopa_bigdata/inputs' USING PigStorage('\t') AS (name:chararray,line:chararray)
...
---store the result
STORE result INTO 'hdfs:///user/Roopa_bigdata/Pigprojectoutput';
